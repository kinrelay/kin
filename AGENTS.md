...
1. Read this file.
2. Read `.github/AGENT_COORDINATION.md` and complete its coordination preflight / claim arbitration before creating a branch, PR, commit, or changing code for an issue.
3. Read the current issue completely, including acceptance criteria and non-goals.
...
7. State assumptions explicitly in the PR when the issue leaves material ambiguity.
